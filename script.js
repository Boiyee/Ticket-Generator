...
const textInputs = document.querySelectorAll('.required'); // Fixed selector to use class
...
function validateFile(input, hint) {
    ...
    if (!file) {
        ...
        if (!validTypes.includes(file.type)) {
            ...
            hint.classList.remove('error');
            hint.innerHTML = '<img src="./assets/images/icon-info.svg" alt="Info Icon"> Upload your photo (JPG or PNG, max size: 500kb).'; // Fixed path and HTML
...
function storeAndDisplayFormData() {
    ...
    formData.githubUsername = document.getElementById('github-username').value.trim();
